...
if (aspectRatio > windowRatio) aspectModifier = heightScale;
else aspectModifier = widthScale;
...
function animate(timestamp){
    ...
    scrollingCtx.clearRect(0, 0, canvas.width, canvas.height);
    gameObjects.forEach(object => {
        object.update(aspectModifier);
        object.draw(aspectModifier);
    });
